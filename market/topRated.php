        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="section-heading">
                    <h2>Bidhaa Zinazouzwa Zaidi</h2>
                    <span>Gundua bidhaa ambazo zimeuzwa zaidi.</span>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            <?php if (!empty($mostSoldProducts)): ?>
                                    ...
                                    <div class="hover-content">
                                        <ul class="list-inline" style="margin: 0; padding: 0;">
                                            <li class="list-inline-item">
                                                <a href="single-product.php?id=<?php echo $product['id']; ?>" style="color: black; border: 1px solid black; padding: 5px; display: inline-block;">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript:void(0)" class="rate-product" data-product-id="<?php echo $product['id']; ?>" style="color: black; border: 1px solid black; padding: 5px; display: inline-block;">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Hakuna bidhaa zilizouzwa zilizopatikana.</p>
            <?php endif; ?>
        </div>
    </div>
</section>
