...
if ($_POST && isset($_POST['action']) && $_POST['action'] === 'add_beneficiary') {
    ...
    if (empty($error)) {
        if ($beneficiaryModel->addWanufaika($name, $title, $description, $photo)) {
            $success = "Mwanufaika ameongezwa kikamilifu!";
            // Clear form data after successful submission
            $_POST = array();
        } else {
            $error = "Imefeli kuongeza mwanufaika. Tafadhali jaribu tena.";
        }
    }
}
?>
...
<head>
    ...
    <title>Ongeza Mwanufaika - Panda Digital</title>
...
<body>
    ...
    <div class="content-wrapper">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-0">
                            ...
                            Ongeza Mwanufaika Mpya
                        </h1>
                        <p class="text-muted">Ongeza hadithi ya mafanikio mpya ya mwanufaika</p>
                    </div>
        ...
        <div class="add-beneficiary-form">
            <form method="POST" action="" enctype="multipart/form-data" id="addBeneficiaryForm">
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <textarea class="form-control form-textarea" id="description" name="description"
                            rows="6" placeholder="Maelezo kamili ya mafanikio ya mwanufaika..." required><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="help-text">Picha ya mwanufaika au ya biashara yake</div>
                    </div>
                </div>
