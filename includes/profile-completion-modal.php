...
<?php if ($canShowModal && isset($profileStatus) && isset($fieldLabels) && isset($regions) && isset($genderOptions)): ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (profileCompletionForm && actionRequiredMessage && actionMessageText) {
