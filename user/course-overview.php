                    ...
                    <div class="col-md-4 text-end">
                        ...
                        <?php else: ?>
                            <?php if ($course['courseIsPaidStatusId'] == 1): ?>
                                <button type="button" class="btn btn-primary text-white" onclick="openPaymentModal(<?php echo $courseId; ?>, '<?php echo htmlspecialchars($course['name']); ?>', <?php echo $course['price']; ?>)">
