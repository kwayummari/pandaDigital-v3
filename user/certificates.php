...
// Check profile completion for certificate access
$userModel = new User($pdo);
$profileCompletionStatus = getProfileCompletionStatus($userModel, $currentUser['id']);

// If profile is not complete, require completion before accessing certificates
if (!$hasMinimumProfile($userModel, $currentUser['id'])) {
    requireProfileCompletion($userModel, $currentUser['id'], 'certificates');
}
